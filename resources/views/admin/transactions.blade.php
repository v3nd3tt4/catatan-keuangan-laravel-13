<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Semua Transaksi</h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border-t-4 {{ ($totalIncome - $totalExpense) >= 0 ? 'border-green-500' : 'border-red-500' }}">
                    ...
                    <div class="mt-2 text-3xl font-bold {{ ($totalIncome - $totalExpense) >= 0 ? 'text-green-600' : 'text-red-600' }}">
                        ...
                        <tbody>
                            @forelse($transactions as $transaction)
                                <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                                    <td class="py-4 px-6 text-sm font-medium text-gray-900">{{ $transaction->user->name }}</td>
